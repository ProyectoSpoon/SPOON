-- =====================================================
-- SPOON - DATOS FINALES CORREGIDOS
-- =====================================================
-- Archivo: 12-final-correct-data.sql
-- Propósito: Crear categorías y productos con valores enum correctos
-- Fecha: 7 de Enero, 2025
-- Versión: 1.0
-- =====================================================

-- Crear categorías con valores enum correctos
DO $$
DECLARE
...
BEGIN
    ...
    IF first_restaurant_id IS NOT NULL THEN
        ...
        (gen_random_uuid(), first_restaurant_id, 'Entradas', 'Sopas y entradas', 'entradas', 'entrada', '#FF6B35', 1, true, user_id, user_id),
        (gen_random_uuid(), first_restaurant_id, 'Principios', 'Platos principales', 'principios', 'principio', '#4ECDC4', 2, true, user_id, user_id),
        (gen_random_uuid(), first_restaurant_id, 'Proteinas', 'Carnes y proteínas', 'proteinas', 'proteina', '#45B7D1', 3, true, user_id, user_id),
        (gen_random_uuid(), first_restaurant_id, 'Bebidas', 'Bebidas frías y calientes', 'bebidas', 'bebida', '#96CEB4', 4, true, user_id, user_id),
        (gen_random_uuid(), first_restaurant_id, 'Acompanamientos', 'Acompañamientos y postres', 'acompanamientos', 'acompanamiento', '#FFEAA7', 5, true, user_id, user_id);
    END IF;
END $$;
