    ...
    <div className="max-w-7xl mx-auto p-6 space-y-8">
      ...
      <div className="flex gap-1">
        {DIAS_SEMANA.map((dia) => (
          <button
            ...
            className={`px-4 py-2 text-sm font-medium rounded-lg transition-colors ${diaSeleccionado === dia
      ...
      <div className="flex justify-end pt-6 border-t border-gray-200">
        <button
          ...
          className={`flex items-center gap-2 px-6 py-2 rounded-lg font-medium transition-colors ${(tieneHorariosConfigurados() && !guardando)
