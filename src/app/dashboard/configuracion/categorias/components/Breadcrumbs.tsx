  ...
  return (
    <div className="flex items-center text-sm mb-4 bg-gray-50 p-3 rounded-lg">
      <button 
        ...
        className={`${currentView === 'tipos' ? 'font-semibold text-[#F4821F]' : 'text-gray-600 hover:text-[#F4821F]'}`}
      >
      ...
      {tipoActual && (
        <>
          ...
          <button 
            ...
            className={`${currentView === 'categorias' ? 'font-semibold text-[#F4821F]' : 'text-gray-600 hover:text-[#F4821F]'}`}
          >
            {tipoActual.nombre}
          </button>
        </>
      ...
      {categoriaActual && (
        <>
          ...
          <button 
            ...
            className={`${currentView === 'subcategorias' ? 'font-semibold text-[#F4821F]' : 'text-gray-600 hover:text-[#F4821F]'}`}
          >
